...
const AdditionalDetails = () => {
  ...
  <div className="border border-solid p-16 pt-12  rounded-xl border-black shadow-2xl    ">
    <form className="max-w-md mx-auto">
   
    <h2 className="font-bold  text-black mb-10 text-6xl">Log In</h2>
      ...
      <p className="text-black">Don't have an account? <a href="./register">Register</a></p>
        ...
        <button className="btn mt-4 w-full text-white">Log In</button>
      </form>
      </div>
      </div>
